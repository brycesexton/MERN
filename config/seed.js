...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Line Chronic 94', image: 'https://curated-upload.imgix.net/AgAAAB0A139KO7k8Ma-EX8WqKgjNMQ.png?auto=compress%2Cformat&ch=Width%2CDPR%2CSave-Data&ixlib=react-9.4.0&w=2066', category: categories[2], price: 439.95},

...
(async function() {
  ...
  const items = await Item.create([
    ...
    {name: 'Helly Hansen Ridge Jacket', image: 'https://www.hellyhansen.com/media/catalog/product/6/5/65809_658-1-onbody1.jpg?auto=webp&format=pjpg&fit=cover&height=640&width=640', category: categories[0], price: 691.95},
    ...
    {name: 'Rossignol Alltrack 130 Boots', image: 'https://curated-upload.imgix.net/AgAAAB0Aji9C7uhgNm2xq5Djp4fPlg.png?auto=compress%2Cformat&ch=Width%2CDPR%2CSave-Data&ixlib=react-9.4.0&w=2066', category: categories[4], price: 469.95},
    ...
    {name: 'Dakine Nova Mitten', image: 'https://curated-upload.imgix.net/AgAAAB0Autc6UzSiP_eTlUG37htOvQ.jpg?auto=compress%2Cformat&ch=Width%2CDPR%2CSave-Data&ixlib=react-9.4.0&w=2066', category: categories[7], price: 33.50},
    {name: 'Burton Profile Gloves', image: 'https://curated-upload.imgix.net/AgAAAB0ABv9t__gdPDq52KGLqehf2w.png?auto=compress%2Cformat&ch=Width%2CDPR%2CSave-Data&ixlib=react-9.4.0&w=2066', category: categories[7], price: 49.95},
    {name: 'Coffee', image: '☕', category: categories[8], price: 0.95},
    {name: 'Mai Tai', image: '🍹', category: categories[8], price: 8.95},
  ]);
